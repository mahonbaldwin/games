...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_45469 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_45469(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_45470 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_45470(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45471 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45471(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45472 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45472(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45473 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45473(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45474 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45474(reader);
}
});
...
var G__45489 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__45490 = s.append(c);
c = G__45489;
s = G__45490;
continue;
}
