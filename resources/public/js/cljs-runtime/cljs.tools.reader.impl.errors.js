...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq45475){
var G__45476 = cljs.core.first(seq45475);
var seq45475__$1 = cljs.core.next(seq45475);
var G__45477 = cljs.core.first(seq45475__$1);
var seq45475__$2 = cljs.core.next(seq45475__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45476,G__45477,seq45475__$2);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___45523 = arguments.length;
var i__4865__auto___45524 = (0);
while(true){
if((i__4865__auto___45524 < len__4864__auto___45523)){
args__4870__auto__.push((arguments[i__4865__auto___45524]));

var G__45525 = (i__4865__auto___45524 + (1));
i__4865__auto___45524 = G__45525;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq45478){
var G__45479 = cljs.core.first(seq45478);
var seq45478__$1 = cljs.core.next(seq45478);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45479,seq45478__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___45526 = arguments.length;
var i__4865__auto___45527 = (0);
while(true){
if((i__4865__auto___45527 < len__4864__auto___45526)){
args__4870__auto__.push((arguments[i__4865__auto___45527]));

var G__45528 = (i__4865__auto___45527 + (1));
i__4865__auto___45527 = G__45528;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq45480){
var G__45481 = cljs.core.first(seq45480);
var seq45480__$1 = cljs.core.next(seq45480);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45481,seq45480__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___45529 = arguments.length;
var i__4865__auto___45530 = (0);
while(true){
if((i__4865__auto___45530 < len__4864__auto___45529)){
args__4870__auto__.push((arguments[i__4865__auto___45530]));

var G__45531 = (i__4865__auto___45530 + (1));
i__4865__auto___45530 = G__45531;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq45482){
var G__45483 = cljs.core.first(seq45482);
var seq45482__$1 = cljs.core.next(seq45482);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45483,seq45482__$1);
}));
...
var init = (function (){var G__45494 = kind;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45494__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq45491){
var G__45492 = cljs.core.first(seq45491);
var seq45491__$1 = cljs.core.next(seq45491);
var G__45493 = cljs.core.first(seq45491__$1);
var seq45491__$2 = cljs.core.next(seq45491__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45492,G__45493,seq45491__$2);
}));
...
var iter__4652__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__45505(s__45506){
return (new cljs.core.LazySeq(null,(function (){
var s__45506__$1 = s__45506;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__45506__$1);
if(temp__5753__auto__){
var s__45506__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__45506__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__45506__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__45508 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__45507 = (0);
while(true){
if((i__45507 < size__4651__auto__)){
var vec__45509 = cljs.core._nth(c__4650__auto__,i__45507);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45509,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45509,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__45508,id);

var G__45540 = (i__45507 + (1));
i__45507 = G__45540;
continue;
} else {
var G__45541 = (i__45507 + (1));
i__45507 = G__45541;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45508),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__45505(cljs.core.chunk_rest(s__45506__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45508),null);
}
} else {
var vec__45512 = cljs.core.first(s__45506__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45512,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45512,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__45505(cljs.core.rest(s__45506__$2)));
} else {
var G__45542 = cljs.core.rest(s__45506__$2);
s__45506__$1 = G__45542;
continue;
}
}
} else {
