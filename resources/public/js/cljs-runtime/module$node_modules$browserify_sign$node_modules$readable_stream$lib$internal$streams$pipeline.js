...
1;return destroyer(stream,reading,0<i,function(err){error||=err;err&&destroys.forEach(call);reading||(destroys.forEach(call),callback(error))})});return streams.reduce(pipe)}}
//# sourceMappingURL=module$node_modules$browserify_sign$node_modules$readable_stream$lib$internal$streams$pipeline.js.map
