...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_47383 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_47383(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_47384 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_47384(runtime,key,spec);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_47386 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_47386(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_47392 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_47392(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_47394 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_47394(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__47373,callback){
var map__47374 = p__47373;
var map__47374__$1 = cljs.core.__destructure_map(map__47374);
var input = map__47374__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47374__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47374__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
