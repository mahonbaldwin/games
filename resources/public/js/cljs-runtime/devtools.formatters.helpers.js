...
var G__43013 = devtools.prefs.pref(v);
v = G__43013;
continue;
} else {
return v;
...
}catch (e42919){var _e__41787__auto__ = e42919;
return false;
}})();
...
}catch (e42921){var _e__41787__auto__ = e42921;
return false;
}})();
...
}catch (e42923){var _e__41787__auto__ = e42923;
return false;
}}
}
});
...
var vec__42951 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42951,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42951,(1),null);
...
return cljs.core.some((function (p1__42977_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42977_SHARP_);
}),template);
});
